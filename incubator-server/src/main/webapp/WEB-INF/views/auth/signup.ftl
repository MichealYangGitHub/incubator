...
<div>
    ...
    <form id="signup" class="form-horizontal col-md-4 col-md-offset-2">
        ...
        <div class="form-group">
            <a class="col-lg-offset-8 col-sm-offset-8 col-xs-offset-7" href="${loginUrl!"/auth/user/r/login"}"><i>已有账号？登录</i></a>
        </div>
    </form>
</div>
</body>
...
<script type="text/javascript" src="/static/js/auth/util.js"></script>
